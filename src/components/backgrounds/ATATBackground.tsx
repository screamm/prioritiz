...
import './ATATBackground.css'

/**
 * AT-AT Walker Background
 *
 * Star Wars inspired walking AT-AT animation with Hoth-like landscape
 * Based on CSS animation by r4ms3s (CodePen)
 */

const ATATBackground = memo(function ATATBackground() {
  return (
    <section className="atat-scene">
      <div className="at-at">
      ...
      <div className="first-bg">
        ...
        <div className="second-bg-anim">
          <div className="first-rock-content">
            {[1, 2, 3, 4, 5, 6].map((n) => (
              <div key={`rock-content-first-${n}`} className={`rock-content rock-content-${n}`}>
          ...
          <div className="second-rock-content">
            {[1, 2, 3, 4, 5, 6].map((n) => (
              <div key={`rock-content-second-${n}`} className={`rock-content rock-content-${n}`}>
                <i className="rock rock-big rock-1"></i>
                <i className="rock rock-big rock-2"></i>
                <i className="rock rock-big rock-3"></i>
                <i className="rock rock-middle rock-7"></i>
